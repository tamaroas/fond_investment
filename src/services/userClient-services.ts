...
export class UserClientService extends HttpService {
  ...
  public async activateUserClient(id: string): Promise<UserClientResponse> {
    return this.patch(`/client/${id}/activer`, {});
  }

  public async deactivateUserClient(id: string): Promise<UserClientResponse> {
    return this.patch(`/client/${id}/suspend`, {});
  }
}
