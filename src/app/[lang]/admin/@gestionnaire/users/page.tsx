            ...
            <Button
              ...
              onClick={() => {
                if (selectedClient?.id) {
                  deleteUserClientMutation.mutate(selectedClient.id, {
                    onSuccess: () => {
                      setIsDeleteDialogOpen(false);
                      refetch();
                    }
        ...
        <DialogContent className="sm:max-w-[425px] bg-white p-4">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              onClick={() => {
                if (selectedClient?.id) {
                  activateUserClientMutation.mutate(selectedClient.id, {
                    onSuccess: () => {
              ...
              disabled={activateUserClientMutation.isPending}
            >
              {activateUserClientMutation.isPending ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  Activation...
                </>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white p-4">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              onClick={() => {
                if (selectedClient?.id) {
                  deactivateUserClientMutation.mutate(selectedClient.id, {
                    onSuccess: () => {
              ...
              disabled={deactivateUserClientMutation.isPending}
            >
              {deactivateUserClientMutation.isPending ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  Désactivation...
                </>
  ...
  return (
    ...
    >
      ...
      <TableCell className=" flex items-center justify-center">
        {client.statutClient === "SUSPENDU" ? (
          <span title="Client suspendu" className="text-white bg-orange-500 p-2 rounded-full whitespace-nowrap">
          </span>
        ) : (
          <span title="Client actif" className="text-white bg-green-500 p-2 rounded-full whitespace-nowrap">
          </span>
        )}
      </TableCell>
