...
import { userServiceRegister, userServiceWidrawalMethodAddmomo } from "@/utils/services/userServices"
import { WithdrawalMethodMomoformSchema } from "@/lib/zodSchema"
...
function AddMomoWithdrawForm(props: Props) {
    ...
    const form = useForm<z.infer<typeof WithdrawalMethodMomoformSchema>>({
        resolver: zodResolver(WithdrawalMethodMomoformSchema),
        defaultValues: {
    ...
    function onSubmit(data: z.infer<typeof WithdrawalMethodMomoformSchema>) {
        userServiceWidrawalMethodAddmomo(data, processSubmit);
        setIsLoader(true)
    }
...
export default AddMomoWithdrawForm