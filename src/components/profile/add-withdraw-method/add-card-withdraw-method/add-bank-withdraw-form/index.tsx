...
import { userServiceRegister, userServiceWidrawalMethodAdd } from "@/utils/services/userServices"
import { WithdrawalMethodBankformSchema } from "@/lib/zodSchema"
...
function AddBankWithdrawForm(props: Props) {
    ...
    const form = useForm<z.infer<typeof WithdrawalMethodBankformSchema>>({
        resolver: zodResolver(WithdrawalMethodBankformSchema),
        defaultValues: {
    ...
    function onSubmit(data: z.infer<typeof WithdrawalMethodBankformSchema>) {
        userServiceWidrawalMethodAdd(data, processSubmit);
        setIsLoader(true);
    }
            ...
            <Form {...form}>
                <CardContent>
                    <form noValidate onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        />
                        <FormFieldCustom
                            label={'Entrer le nom de la banque *'}
                        ...
                        />
                        <FormFieldCustom
                            label={'Entrer Votre Numéro De Compte Bancaire *'}
                        ...
                        />
                        <FormFieldCustom
                            label={'Entrer Votre IBAN De Compte Bancaire *'}
                            placeholder={'IBAN De Compte Bancaire'}
                            form={form}
                            name="bank_iban"
                            type="text"
                        />
                        <FormFieldCustom
                            label={'Entrer Votre SWIFT De Compte Bancaire *'}
                            placeholder={'SWIFT De Compte Bancaire'}
                            form={form}
                            name="bank_swift"
                            type="text"
                        />
...
export default AddBankWithdrawForm