...
import { getSidebarMenuList } from "@/utils/menu-list";
...
export function SidebarMenu({ isOpen, dictionary }: MenuProps) {
                        ...
                        <Tooltip delayDuration={100}>
                          <TooltipTrigger asChild>
                            <Button
                              ...
                              asChild
                            >
                              <Link href={href} className=" flex items-center my-3 ">
                                <span
          ...
          <li className="w-full grow flex items-end">
            <TooltipProvider disableHoverableContent>
              <Tooltip delayDuration={100}>
                ...
                {isOpen === false && (
                  <TooltipContent side="right" onClick={() => { signOut() }}>{isLoader ? <></> : 'Sign out7'}</TooltipContent>
                )}
              </Tooltip>
            </TooltipProvider>
          </li>
